...
# Copy Templates to blob storage
$storageContext = New-AzureStorageContext -StorageAccountName:$storageAccount -StorageAccountKey:$storageAccountKey
get-childitem *.json | Set-AzureStorageBlobContent -Container:$container -Context:$storageContext -Force

$TemplateUrl = (Get-AzureStorageContainer -Name:$container-Context:$storageContext).CloudBlobContainer.Uri.AbsoluteUri
